/*
Susumuoti (sveikuosius) skaicius nuo iki.

jeigu from mazesnis uz to, tai
ciklas from to
else
to from
    if (from === -Infinity || from === Infinity || '' + from === 'NaN') {
        return 'ERROR. Cia turi buti normalus skaicius.'
    }
    if (to === -Infinity || to === Infinity || '' + to === 'NaN') {
        return 'ERROR. Cia turi buti normalus skaicius.'
    }
 */
console.clear();
